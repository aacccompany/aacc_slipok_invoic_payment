{
    'name': 'LINE Payment & SlipOK Auto-Verify Integration',
    'version': '19.0.1.0.0',
    'category': 'Accounting/Accounting',
    'summary': 'Automate invoice payments via LINE with SlipOK Verification, Dynamic QR Codes, and Auto-Reconciliation',
    'description': """
LINE Payment & SlipOK Auto-Verify Integration
=============================================
...
* **Automated Slip Verification**: Customers upload their bank slips to the chat, and the SlipOK API verifies the exact amount, transaction ID, and receiver bank automatically.
